...
?>
<form action="<?=$configs['document_root']?>/funcionalidade/editar/<?=$funcionalidade['idHistoria']?>/<?=$funcionalidade['idFuncionalidade']?>" method="post">
    <div class="form-row">
        <div class="form-group col-md-2">
            ...
            <input type="text" class="form-control" id="inputIdHistoria" aria-describedby="inputIdHistoria"
                   placeholder="idHistoria" name="idHistoria" value="<?=$funcionalidade['idHistoria']?>">
        </div>
        <div class="form-group col-md-3">
            ...
            <input type="text" class="form-control" id="inputIdFuncionalidade" aria-describedby="inputIdFuncionalidade"
                   placeholder="idFuncionalidade" name="idFuncionalidade" value="<?= $funcionalidade['idFuncionalidade']?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="inputFuncionalidade" aria-describedby="inputFuncionalidade"
               placeholder="Funcionalidade" name="Funcionalidade" value="<?=$funcionalidade['funcionalidade']?>">
    </div>
    </div>
