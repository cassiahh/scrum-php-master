...
class TarefaDao {
	...
	function insereTarefa(Tarefa $tarefa) {
		$idSprint = ($tarefa->getIdSprint() == "") ? 'null' : $tarefa->getIdSprint();
		$query = "insert into Tarefa (idHistoria, idFuncionalidade, idTarefa, tarefa, idSprint, ra, status, duracao, dependencia, prioridade)
            values (
